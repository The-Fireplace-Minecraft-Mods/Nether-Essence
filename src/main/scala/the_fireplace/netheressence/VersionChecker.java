 ...
 */
@Mod(modid="netheressencevc", name="Nether Essence Version Checker", version=VersionChecker.VERSION)
public class VersionChecker {
    private static final String HostMODID=NetherEssence.MODID();
    private static final String HostMODNAME= NetherEssence.MODNAME();
    private static final String HostVERSION=NetherEssence.VERSION();
    ...
    public VersionChecker(){
        latest = stringAt(NetherEssence.LATEST());
        downloadURL = NetherEssence.downloadURL();
    }
