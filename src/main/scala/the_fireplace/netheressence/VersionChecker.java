 ...
 */
@Mod(modid=VersionChecker.MODID, name=VersionChecker.MODNAME, version=VersionChecker.VERSION, guiFactory = "the_fireplace.netheressence.VersionChecker$VCGui")
public class VersionChecker {
    static final String HostMODID="netheressence";
    private static final String HostMODNAME="Nether Essence";
    ...
    public VersionChecker(){
        curseCode = NetherEssence.curseCode();
    }
    ...
    public void init(FMLInitializationEvent event){
        HostVERSION=NetherEssence.VERSION();
        tryNotifyDynious();
